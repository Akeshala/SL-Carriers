                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body bio-graph-info">
                                                    <div class="row">
                                                        ...
                                                        <div class="bio-row">
                                                            <p><span>Field 1 </span>: <?php echo $_SESSION['field1']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Field 2 </span>: <?php echo $_SESSION['field2']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Field 3 </span>: <?php echo $_SESSION['field3']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
