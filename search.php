    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="icon_search"></i><strong> Search</strong></h3>
                    </div>
                </div>
            </section>
            ...
            <div class="container">
                ...
                <br />
                <br />
                <h2 align="center">Search for Employees</h2><br />
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon">Search</span>
                        <input type="text" name="search_text" id="search_text" placeholder="Search by Employee details, e.g :- 'ENTC', 'Software Engineering', 'Country', 'City' " class="form-control" />
                    </div>
                </div>
                <br />
                <div id="result"></div>
