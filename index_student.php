                            ...
                            <div class="profile-widget profile-widget-info">
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-4 col-sm-4 follow-info">
                                        <p>Hello I’m <?php echo $_SESSION['username']; ?>, a leading expert in <?php echo $_SESSION['position1']; ?>.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <section class="panel">
                                                <div class="panel-body bio-graph-info">
                                                    <div class="row">
                                                        ...
                                                        <div class="bio-row">
                                                            <p><span>Field</span>: <?php echo $_SESSION['field']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Apartment Number </span>: <?php echo $_SESSION['apartmentnumber']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                        ...
                                                        <div class="bio-row">
                                                            <p><span>Telephone number </span>: <?php echo $_SESSION['phone']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Interested Position 1 </span>: <?php echo $_SESSION['position1']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Interested Position 2 </span>: <?php echo $_SESSION['position2']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Interested Position 3 </span>: <?php echo $_SESSION['position3']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Interested Position 4 </span>: <?php echo $_SESSION['position3']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
                                                            <p><span>Salary Expects </span>: <?php echo $_SESSION['salary']; ?></p>
                                                        </div>
                                                        <div class="bio-row">
